...
: ${AMENT_CURRENT_PREFIX:="/root/capstone_ws/install/deepracer_main"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/deepracer_main/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/deepracer_main/environment/path.sh"
