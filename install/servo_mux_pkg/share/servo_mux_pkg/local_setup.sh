...
: ${AMENT_CURRENT_PREFIX:="/root/capstone_ws/install/servo_mux_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_mux_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/servo_mux_pkg/environment/path.sh"
