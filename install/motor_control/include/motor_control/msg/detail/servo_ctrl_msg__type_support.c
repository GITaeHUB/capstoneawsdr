...
#include <stddef.h>
#include "motor_control/msg/detail/servo_ctrl_msg__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  motor_control__msg__ServoCtrlMsg__init(message_memory);
}

void ServoCtrlMsg__rosidl_typesupport_introspection_c__ServoCtrlMsg_fini_function(void * message_memory)
{
  motor_control__msg__ServoCtrlMsg__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ServoCtrlMsg__rosidl_typesupport_introspection_c__ServoCtrlMsg_message_member_array[2] = {
  {
    ...
    offsetof(motor_control__msg__ServoCtrlMsg, angle),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_control__msg__ServoCtrlMsg, throttle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ServoCtrlMsg__rosidl_typesupport_introspection_c__ServoCtrlMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(motor_control__msg__ServoCtrlMsg),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_control, msg, ServoCtrlMsg)() {
