...
static const _ObjectInfo_type_support_symbol_names_t _ObjectInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rplidar_ros, msg, ObjectInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rplidar_ros, msg, ObjectInfo)),
  }
};
...
{
  return &::rplidar_ros::msg::rosidl_typesupport_cpp::ObjectInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rplidar_ros, msg, ObjectInfo)() {
  return get_message_type_support_handle<rplidar_ros::msg::ObjectInfo>();
}
