...
static const _ObjectInfo_type_support_symbol_names_t _ObjectInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rplidar_ros, msg, ObjectInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rplidar_ros, msg, ObjectInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rplidar_ros, msg, ObjectInfo)() {
  return &::rplidar_ros::msg::rosidl_typesupport_c::ObjectInfo_message_type_support_handle;
}
