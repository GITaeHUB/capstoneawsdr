...
: ${AMENT_CURRENT_PREFIX:="/root/capstone_ws/install/rplidar_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rplidar_ros/environment/library_path.sh"
