...
#include "motor_control/msg/detail/servo_ctrl_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const motor_control::msg::ServoCtrlMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_control::msg::ServoCtrlMsg *>(
    untyped_ros_message);
...
{
  return &motor_control::msg::typesupport_fastrtps_cpp::_ServoCtrlMsg__handle;
}
