...
static const _ServoCtrlMsg_type_support_symbol_names_t _ServoCtrlMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_control, msg, ServoCtrlMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, motor_control, msg, ServoCtrlMsg)),
  }
};
...
{
  return &::motor_control::msg::rosidl_typesupport_cpp::ServoCtrlMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, motor_control, msg, ServoCtrlMsg)() {
  return get_message_type_support_handle<motor_control::msg::ServoCtrlMsg>();
}
