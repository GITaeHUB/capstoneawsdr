...
#include "motor_control/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _ServoCtrlMsg_type_support_symbol_names_t _ServoCtrlMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motor_control, msg, ServoCtrlMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motor_control, msg, ServoCtrlMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_motor_control
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motor_control, msg, ServoCtrlMsg)() {
  return &::motor_control::msg::rosidl_typesupport_c::ServoCtrlMsg_message_type_support_handle;
}
